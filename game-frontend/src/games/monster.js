import { SoundManager } from '../game-shared/soundManager.js'
import { saveScoreToDatabase } from '../game-shared/scoreManager.js'
/* global MonsterExtension */
...
window.MonsterGame = MonsterGame;
    ...
    gameOver: function() {
        ...
        saveScoreToDatabase('monster', this.score || 0); 
    }
