...
function TabOverview({ gamesList, recordKeys, highScores, currentLevel, safeExp, expNeededForNextLevel, progressPercent, achievementsList, getAchievementProgress, setActiveTab }) {
