...
export function detectGameColor() {
...
const headerHTML = `
    ...
    ">
        ...
        <div style="display: flex; align-items: center; gap: 24px;">
            ...
            <button onclick="window.handleGlobalLogout()" style="background: transparent; border: 1px solid #ff4d4d88; color: #ff4d4d; cursor: pointer; display: flex; align-items: center; gap: 6px; font-weight: 800; padding: 6px 12px; border-radius: 8px; font-size: 11px; transition: 0.2s;">
...
document.getElementById('help-btn').addEventListener('click', async () => {
    ...
    try {
        const response = await fetch(`/api/game/instructions/${slug}`);
